...
export const enLocalization = {
    ...
    'info.dev_options.core_review.update': 'Refresh',

    'info.dev_options.locale.title': 'Localization review',
    'info.dev_options.locale.default_lang': 'Default language',
    'info.dev_options.locale.body': 'Click to see details',

    'info.dev_options.locale.single.translated': 'View §2translated§8 keys',
    'info.dev_options.locale.single.excessive': 'View §6excessive§8 keys',
    'info.dev_options.locale.single.missing': 'View §4missing§8 keys',
    'info.dev_options.locale.single.default': 'This is default Arx language. All other language key values are calculated from this one as a reference.',
    'info.dev_options.locale.single.show_keys.no_keys': 'No keys',
    'info.dev_options.locale.single.show_keys.title': '$0$ in $1$',
    'info.dev_options.locale.single.type.translated': '§2Translated§8',
    'info.dev_options.locale.single.type.excessive': '§6Excessive§8',
    'info.dev_options.locale.single.type.missing': '§4Missing§8',
